...
{Cavity-induced perturbations on the quantum Hall effect in graphene}{}
\resumeEducationHeading
...
\section{Research Experience}
	\vspace{3pt}
	\resumeSubHeadingListStart
\resumeSubheading{\href{https://lpmmc.cnrs.fr/spip.php?auteur132}{Laboratoire de Physique et Modélisation des Milieux Condensés, CNRS\faLink}}{Grenoble, France}{PhD Studying  }{Nov 2025 \textbf{--} October 2028}
\resumeItemListStart
\resumeItem{\justifying{Working on the Anderson localisation under the effect of the light-matter interaction with Matsubara Green function approach under the supervision of Drs. Denis Basko, Loic Herviou and Thierry Champel.}}
\resumeItem{\justifying{Modeling and estimating the cavity effects on integer quantum Hall states.}}
\resumeItemListEnd
...
\resumeItemListStart
\resumeItem{\justifying{Worked on Altermagnetic material RuO\(_2\) with the DFT calculation using GGA + U approach. Porting to Wannier90 to minimized the localize Wannier's function and attempt to calculate the transport properties.}}
	...
	\resumeSubheading
	{Institute of Applied Mechanics and Informatics, VAST}{Ho Chi Minh city, Vietnam}
...
\section{References}
\resumeSubHeadingListStart
\resumeSubItem{\href{https://lpmmc.cnrs.fr/personal-page-of-denis-basko/}{\Large Denis Basko\faLink}}
\\\vspace{10pt}
\hspace{0.5cm}{Directeur de Recherche}\\
\hspace{0.5cm}{Laboratoire de Physique et Modelisation des Milieux Condenses, CNRS, France}\\
\hspace{0.5cm}\faAt\href{mailto:denis.basko@lpmmc.cnrs.fr}{\color{blue}\null \hspace{1pt} denis.basko@lpmmc.cnrs.fr}
\\\hspace{0.5cm}Dr. Denis Basko is the co-supervisor of my PhD at lab LPMMC, CNRS Grenoble (2026 - present).

\resumeSubItem{\href{https://lherviou.github.io/}{\Large Loïc Herviou\faLink}}
\\\vspace{10pt}
\hspace{0.5cm}{Chargé de Recherche}\\
\hspace{0.5cm}{Laboratoire de Physique et Modelisation des Milieux Condenses, CNRS, France}\\
\hspace{0.5cm}\faAt\href{mailto:loic.herviou@lpmmc.cnrs.fr}{\color{blue}\null \hspace{1pt} loic.herviou@lpmmc.cnrs.fr}
\\\hspace{0.5cm}Dr. Loïc Herviou is the co-supervisor of my PhD at lab LPMMC, CNRS Grenoble (2026 - present).

\resumeSubItem{\href{https://lpmmc.cnrs.fr/page-personnelle-de-thierry-champel/}{\Large Thierry Champel\faLink}}
\\\vspace{10pt}
\hspace{0.5cm}{Chargé de Recherche}\\
\hspace{0.5cm}{Laboratoire de Physique et Modelisation des Milieux Condenses, CNRS, France}\\
\hspace{0.5cm}\faAt\href{mailto:thierry.champel@lpmmc.cnrs.fr}{\color{blue}\null \hspace{1pt} thierry.champel@lpmmc.cnrs.fr}
\\\hspace{0.5cm}Dr. Thierry Champel is the co-supervisor of my PhD at lab LPMMC, CNRS Grenoble (2026 - present).
...
\\\hspace{0.5cm}Dr. Natasa Stojic is my lecturer and also is the thesis's supervisor in my diploma program at ICTP (2025).
...
\vspace{10pt}
\hspace{0.5cm}Researcher\\\hspace{0.5cm}Vietnam Academy of Science and Technology, Vietnam \\\hspace{0.4cm}
...
\\\hspace{0.5cm}Dr. Huynh Thanh Duc is my supervisor for my works at HCMC Institute of Physics, VAST and also is my thesis's supervisor (2022 - 2024).
\resumeSubHeadingListEnd
	%----------- SKILLS -----------
...
\small{\item{
		...
		\textbf{French:}{ Beginner} \\ \vspace{3pt}
