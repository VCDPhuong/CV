...
\section{Publication}
\vspace{3pt}
\hspace{0.5cm}{\small \textbf{Duc, C.}, \& Huynh, T. D. (2024). Calculation of shift current tensors in two-dimensional transition metal dichalcogenides. E3S Web of Conferences, 496, 02002–02002. \href{	https://doi.org/10.1051/e3sconf/202449602002}{\color{blue}https://doi.org/10.1051/e3sconf/202449602002}}
	%----------- AWARDS & ACHIEVEMENTS -----------
...
\hspace{0.6cm}\textit{Abstract: }Using Semiconductor Bloch Equations, the Coulomb interaction had been taken into account using the Hatree-Fock approximation. This work confirms the exciton binding energy in \(MoS_2\) in agreement with experiments using a model with a minimum number of energy bands.
	...
	\resumeSubHeadingListStart
	\small{\item{
	\textbf{Top \(\textbf{1}^{\textbf{st.}}\) in Physics majors (both in general and honour program) at the University of Science, National University of Ho Chi Minh city:} Archived the top \(1^{st.}\) rank in the physics class, selected for the honours program in the first year due to outstanding performance in high school. (admission class 2020-2024)
	\resumeItemListStart
...
\textbf{\(2^{\textit{nd}}\) Prize in the "National Physics Olympics for College Students":}{ Annual Contest for college students in Vietnam, host by Phenikaa University, Hanoi, Vietnam. (2022)} \\
\resumeItemListStart
...
\textbf{Golden Medals in "Traditional 30/04 Olympiad":}{ An annual academic competition in Vietnam, primarily for high school students from the southern region. It was established by Le Hong Phong High School for the Gifted and first held in 1995. (Award golden medals in both 2018 \& 2019)} \\ \vspace{3pt}
	...
	\textbf{Odon-Vallet Scholarship:}{ The Odon Vallet Scholarship, established by Professor Odon Vallet from Sorbonne University, is awarded annually to outstanding Vietnamese students. Sponsored by the scientific and educational organization "Rencontres du Vietnam," the scholarship aims to support talented students in their academic pursuits. (2018)}}}
	\resumeSubHeadingListEnd
